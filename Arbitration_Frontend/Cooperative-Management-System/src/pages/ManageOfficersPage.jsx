...
const ManageOfficersPage = () => {
  ...
  useEffect(() => {
    filterOfficers();
  }, [selectedDistrict, officers, searchTerm]);
  ...
  const filterOfficers = () => {
    ...
    if (selectedDistrict) {
      result = result.filter((o) => o.districtId === selectedDistrict);
    }
      ...
      >
        <div className="card-body p-4">
          <div className="row align-items-end">
            <div className={isProvincialAdmin ? "col-md-4" : "col-md-6"}>
              <label className="form-label fw-semibold d-flex align-items-center">
      ...
      {filteredOfficers.length === 0 ? (
        ...
        >
          ...
          {selectedDistrict || searchTerm
            ? "සොයාගත් නිර්ණායක වලට ගැලපෙන තීරක නිලධාරීන් නොමැත"
            : "තවම තීරක නිලධාරීන් එකතු කර නොමැත"}
        </div>
      ) : (
        <div
