            ...
            <div className="modal-body p-4">
              ...
              <div className="alert alert-info mb-3" style={{ borderRadius: "8px" }}>
                <div className="row g-2">
                  ...
                  <div className="col-md-6">
                    <small className="text-muted d-block">තීරක අංකය:</small>
                    <strong className="text-danger">{borrower.arbitrationNumber}</strong>
                  </div>
                  <div className="col-md-6">
                    <small className="text-muted d-block">තීරක නිලධාරි:</small>
                    <strong>{borrower.assignedOfficerName || "-"}</strong>
                ...
                <div className="col-md-6">
                  <div className="card border-primary">
                    <div className="card-body p-3">
                      ...
                      <div className="fw-bold text-primary">
                        {borrower.decisionDate
                          ? new Date(borrower.decisionDate).toLocaleDateString("si-LK", {
                ...
                <div className="col-md-6">
                  <div className="card border-danger">
                    <div className="card-body p-3">
                      ...
                      <div className="fw-bold text-danger">
                        {borrower.appealDueDate
                          ? new Date(borrower.appealDueDate).toLocaleDateString("si-LK", {
                              year: "numeric", month: "long", day: "numeric",
                            })
                          : "-"}
                      </div>
              ...
              {/* ── Original Loan Info (with interest period) ── */}
              <div className="card mb-3 border-0 shadow-sm" style={{ borderRadius: "8px" }}>
                <div
                  className="card-header text-white"
                  style={{ background: "linear-gradient(135deg, #6b7280 0%, #4b5563 100%)", borderRadius: "8px 8px 0 0" }}
                >
                  <h6 className="mb-0 fw-bold">
                    <FileText size={16} className="me-2" />
                    මුල් ණය විස්තර
                ...
                <div className="card-body">
                  <div className="row g-3 mb-2">
                    ...
                    <div className="col-md-4">
                      <small className="text-muted d-block">මුල' පොළිය:</small>
                  ...
                  {/* ⭐ Interest Period — only shown if dates exist */}
                  {(borrower.interestFromDate || borrower.interestToDate) && (
                    <div
                      className="d-flex align-items-center flex-wrap gap-3 px-3 py-2 rounded mt-1"
                      style={{
                    ...
                    <table className="table table-borderless mb-0">
                      ...
                      <tbody>
                        ...
                        <tr>
                          <td className="fw-semibold">ණය ශේෂය</td>
                          <td className="text-end fw-bold text-primary">
                            රු. {outstandingLoanAmount.toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                          </td>
                          <td className="text-end fw-bold text-success">
                            රු. {proposedLoanBalance.toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                          </td>
                          <td className="text-end">
                            {loanReduction > 0 ? (
                              <span className="badge bg-success">
                                <TrendingDown size={12} className="me-1" />
                                රු. {loanReduction.toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                              </span>
                            ) : (
                              <span className="text-muted">-</span>
                            )}
                        ...
                        {/* Interest row —  shows period badge inline */}
                        <tr>
                              ...
                              <div className="mt-1">
                                ...
                                >
                                  ...
                                  {borrower.interestToDate
                                    ...
                                    : "?"}
                                  {interestDays !== null && (
                                    <span className="ms-1">({interestDays} දින)</span>
                                  )}
                                </span>
                              </div>
                            )}
                          ...
                          <td className="text-end fw-bold text-success">
                            රු. {proposedLoanInterest.toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                          </td>
                          <td className="text-end">
                            {interestReduction > 0 ? (
                              <span className="badge bg-success">
                                <TrendingDown size={12} className="me-1" />
                                රු. {interestReduction.toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                              </span>
                            ) : (
                              <span className="text-muted">-</span>
                            )}
                        ...
                        {borrower.caseFees && parseFloat(borrower.caseFees) > 0 && (
                          <tr>
                            ...
                            <td className="text-end">-</td>
                            <td className="text-end fw-bold text-info">
                              රු. {parseFloat(borrower.caseFees).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                            </td>
                            <td className="text-end">-</td>
                          </tr>
                        )}
                        ...
                        {/* Grand Total */}
                        <tr style={{ backgroundColor: "#f0f9ff", borderTop: "2px solid #ddd" }}>
                          <td className="fw-bold">මුළු මුදල</td>
                          <td className="text-end fw-bold text-danger fs-5">
                            රු. {(originalLoanAmount + originalInterest).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                          </td>
                          <td className="text-end fw-bold text-success fs-5">
                            රු. {parseFloat(borrower.proposedTotalAmount || 0).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                          </td>
                          <td className="text-end">
                            {loanReduction + interestReduction > 0 ? (
                              <span className="badge bg-success fs-6">
                                <TrendingDown size={14} className="me-1" />
                                රු. {(loanReduction + interestReduction).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                              </span>
                            ) : (
                              <span className="text-muted">-</span>
                            )}
                ...
                <div className="card mb-3 border-0 shadow-sm" style={{ borderRadius: "8px" }}>
                  ...
                  <div className="card-body">
                    <div className="row">
                      {borrower.forwardInterest && (
                        <div className="col-md-6">
                          <small className="text-muted d-block mb-1">ඉදිරියට පොළිය:</small>
                          <div className="fw-bold fs-5 text-success">
                            රු. {parseFloat(borrower.forwardInterest).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                          </div>
                        </div>
                      )}
                      {borrower.forwardInterestRate && (
                        <div className="col-md-6">
                          <small className="text-muted d-block mb-1">ඉදිරියට පොළී අනුපාතය:</small>
                          <div className="fw-bold fs-5 text-success">{borrower.forwardInterestRate}%</div>
                        </div>
                      )}
                    </div>
                  </div>
                  ...
                  <div className="row">
                    {borrower.deductionsFromLoanAmount && (
                      <div className="col-md-6">
                        <small className="d-block mb-1">ණය මුදලෙන්:</small>
                        <strong className="fs-5">
                          රු. {parseFloat(borrower.deductionsFromLoanAmount).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                        </strong>
                      </div>
                    )}
                    {borrower.deductionsFromInterestAmount && (
                      <div className="col-md-6">
                        <small className="d-block mb-1">පොලියෙන්:</small>
                        <strong className="fs-5">
                          රු. {parseFloat(borrower.deductionsFromInterestAmount).toLocaleString("si-LK", { minimumFractionDigits: 2 })}
                        </strong>
                      </div>
                    )}
                  </div>
              ...
              <div className="card border-0 shadow-sm" style={{ borderRadius: "8px" }}>
                ...
                <div className="card-body">
                  <div
                    className="p-3 bg-light rounded"
                    style={{ whiteSpace: "pre-wrap", maxHeight: "300px", overflowY: "auto", fontSize: "14px", lineHeight: "1.8" }}
                  >
                    {borrower.arbitrationDecision}
                  </div>
                </div>
